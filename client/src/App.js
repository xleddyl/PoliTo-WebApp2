   ...
   return (
    <>
      ...
      <div className="flex justify-center items-center">
         {response &&
             <textarea className='w-96 h-40 mt-2 resize-none rounded-md bg-white px-4 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50' defaultValue={JSON.stringify(response, null, 3)} />
         }
         {error && (
